...
// Returns true if addition succeeded.
    public boolean add(K key, V value) {
        if (contains(key) || isFull()) //Checks fullness and duplicates
            return false;
...
// first one found.
    public K getKey(V value) {
        Iterator<Map.Entry<K,V>> iter = branch.entrySet().iterator(); //Used map for finding keys
        while(iter.hasNext()) {
